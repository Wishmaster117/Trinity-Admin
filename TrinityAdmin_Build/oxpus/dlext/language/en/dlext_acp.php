...
'DL_CFG_EXTERNAL_ONLY'          => 'Allow only external links (blocks file uploads for non-admins)',
'DL_CFG_EXTERNAL_ONLY_EXPLAIN'  => 'If enabled, users can only submit a URL; actual file uploading remains available for admins.',
