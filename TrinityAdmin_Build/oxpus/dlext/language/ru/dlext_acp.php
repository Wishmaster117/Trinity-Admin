...
'DL_CFG_EXTERNAL_ONLY'          => 'Разрешить только внешние ссылки (загрузка файлов запрещена для не-админов)',
'DL_CFG_EXTERNAL_ONLY_EXPLAIN'  => 'Если включено, пользователи могут отправлять только URL; загрузка файлов доступна только администраторам.',
