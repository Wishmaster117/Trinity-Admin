...
local function TrinityAdmin_CheckKey()
    -- incohérence entre les deux copies
    if TA_KEY ~= TA_SHADOW_KEY then
        print("|cffff0000[TrinityAdmin]|r Clé d'installation invalide – addon désactivé.")
        return false
    end
    return true
end

-- stoppe immédiatement si la clé est absente/erronée
if not TrinityAdmin_CheckKey() then return end
