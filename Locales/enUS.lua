...
L["reset_spells_desc"] = "Marks spells or talents (including pet talents) to reset at next login for each character."
...
L["Advanced GameObjects"] = "Advanced GameObject Functions"
