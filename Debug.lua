...
function Debug:CreateDebugPanel()
	...
	panel.title:SetText("Debug Panel")
	...
	page1Title:SetText("Debug Functions Page 1")
	...
	debugAreatriggersButton:SetText("Areatriggers Debug is OFF")
	...
	debugAreatriggersButton:SetScript("OnEnter", function(self)
		...
		GameTooltip:SetText("Toggle debug mode for areatriggers. In debug mode GM will be notified if reaching an areatrigger.", 1, 1, 1, 1, true)
		GameTooltip:Show()
	end)
	...
	debugArenaButton:SetText("Arena Debug is OFF")
	...
	debugArenaButton:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
		GameTooltip:SetText("Toggle debug mode for arenas. In debug mode GM can start arena with single player.", 1, 1, 1, 1, true)
		GameTooltip:Show()
	end)
	...
	debugBgButton:SetText("Bg Debug is OFF")
	...
	debugBgButton:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
		GameTooltip:SetText("Toggle debug mode for battlegrounds. In debug mode GM can start battleground with single player.", 1, 1, 1, 1, true)
		GameTooltip:Show()
	end)
	...
	eventFrame:SetScript("OnEvent", function(self, event, msg, ...)
		...
		if msg:find("Areatrigger debugging turned on") then
			debugAreatriggersButton:SetText("Areatriggers Debug is ON")
		...
		if msg:find("Arenas are set to 1v1 for debugging") then
			debugArenaButton:SetText("Arena Debug is ON")
		...
		if msg:find("Battlegrounds are set to 1v0 for debugging") then
			debugBgButton:SetText("Bg Debug is ON")
	...
	debugCombatButton:SetText("Debug Combat")
	...
	debugCombatButton:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
		GameTooltip:SetText("Lists the target's (or own) combat references.", 1, 1, 1, 1, true)
		GameTooltip:Show()
	end)
	...
	debugPhaseButton:SetText("Debug Phase")
	...
	debugPhaseButton:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
		GameTooltip:SetText("Sends a phase debug report of a player to you.", 1, 1, 1, 1, true)
		GameTooltip:Show()
	end)
	...
	debugThreatButton:SetText("Debug Threat")
	...
	debugThreatButton:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
		GameTooltip:SetText("Lists the units threatened by target (or self). If target has a threat list, lists that threat list, too.", 1, 1, 1, 1, true)
		GameTooltip:Show()
	end)
	...
	debugThreatinfoButton:SetText("Debug Threatinfo")
	...
	debugThreatinfoButton:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
		GameTooltip:SetText("Displays various debug information about the target's threat state, modifiers, redirects and similar.", 1, 1, 1, 1, true)
		GameTooltip:Show()
	end)
